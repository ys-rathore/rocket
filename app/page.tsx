...
export default function Home() {
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden bg-transparent">
      ...
      {/* Floating YSpace Logo (visible after loading) */}
      {!loading && (
      ...
      {loading && (
        <div
          className="absolute inset-0 flex flex-col items-center justify-center z-50 
                     bg-gradient-to-br from-[#ffffff] via-[#fefefe] to-[#f0f0f0]
                     backdrop-blur-2xl overflow-hidden animate-[fadeStorm_2s_ease-in-out_forwards]"
        >
          {/* Windy Effect */}
          <div className="absolute inset-0 bg-[url('/noise.png')] opacity-20 mix-blend-overlay animate-[windFlow_2s_linear_infinite]" />
...
/* ✅ Add the animation styles below (Tailwind + custom keyframes) */
